...
from .DocumentoViews import DocumentoCreateView, DocumentoListView, DocumentoPdfView, RotuloPdfView, DocumentoDetailView, DocumentoUpdateView, DocumentoDeleteView
